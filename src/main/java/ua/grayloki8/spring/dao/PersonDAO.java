...
import ua.grayloki8.spring.models.Book;
...
public class PersonDAO {
    ...
    public void save(Person person) {
        jdbcTemplate.update("INSERT INTO Person2(full_name, year_of_birth) VALUES(?, ?)", person.getFullName(),
                person.getYearOfBirth());
    }

    public void update(int id, Person updatedPerson) {
        jdbcTemplate.update("UPDATE Person2 SET full_name=?, year_of_birth=? WHERE id=?", updatedPerson.getFullName(),
    ...
    public Optional<Person> getPersonByFullName(String fullName) {
        return jdbcTemplate.query("SELECT * FROM Person2 WHERE full_name=?", new Object[]{fullName},
